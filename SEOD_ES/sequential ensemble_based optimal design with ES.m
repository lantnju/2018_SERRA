...
y=zeros(2*Node_Num,N,timestep*5);
...
%    waitbar(t/timestep,h)
    ...
    Obst=squeeze([Obs_en(1+(t-1)*5,T1,1:N);Obs_en(2+(t-1)*5,T1,1:N);Obs_en(3+(t-1)*5,T1,1:N);Obs_en(4+(t-1)*5,T1,1:N);Obs_en(5+(t-1)*5,T1,1:N);Obs_en(1+(t-1)*5,T1+Node_Num,1:N);...
                 Obs_en(2+(t-1)*5,T1+Node_Num,1:N);Obs_en(3+(t-1)*5,T1+Node_Num,1:N);Obs_en(4+(t-1)*5,T1+Node_Num,1:N);Obs_en(5+(t-1)*5,T1+Node_Num,1:N)]);
    ...
    y_new=squezze([y(T1,:,1+(t-1)*5);y(T1,:,2+(t-1)*5);y(T1,:,3+(t-1)*5);y(T1,:,4+(t-1)*5);y(T1,:,5+(t-1)*5);y(T1+Node_Num,:,1+(t-1)*5);...
